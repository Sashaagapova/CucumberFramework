...
public class HRApplicationSteps {
    ...
    List <Map<String, Object>> expectedFirstName;
    ...
    public void go_to_Database_and_get_First_name_and_Last_name_of_employees_who_works_in_Europe_and_validate_with_their_UI_information_First_name_Last_Name() throws Throwable {
        ...
        try {
            ...
            List<Map<String, Object>> expectedFirstNames = JDBCUtils.runSQLQuery("select e.first_name, e.last_name\n" +
            ...
            for (int i=0;i<hrApplicationPage.listOfFirstNames.size();i++){
                if(hrApplicationPage.listOfFirstNames.get(i).getText().equalsIgnoreCase(expectedFirstNames.get(i).get("FIRST_NAME").toString())){
        ...
        public void go_to_Excel_and_update_column_Actual_of_Employees_with_number_of_Europe_employees_that_you_get_from_UI () throws Throwable {
                ...
                Assert.assertEquals(ExcelUtils.getValue(1,1)), JDBCUtils.countRows("\"select e.first_name, e.last_name\\n\" +\n" +
                        "                    \"from employees e join departments d on\\n\" +\n" +
                        "                    \"e.department_id=d.department_id\\n\" +\n" +
                        "                    \"join locations l on\\n\" +\n" +
                        "                    \"d.location_id=l.location_id\\n\" +\n" +
        ...
        public void compare_Actual_of_Employees_with_expected_of_Employees_and_if_they_matched_then_update_Test_Execution_Status_cell_as_PASSED_if_not_match_then_update_with_FAILED
        () throws Throwable {
