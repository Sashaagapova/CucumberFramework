...
@smokeTest
  Scenario: Verify create order functionality
    ...
    Then User creates new order
      ...
      | ScreenSaver  | 2        | Techtorial    | 123 N tech | Chicago | IL    | 60000 | 1234567 | 12/21       |
    ...
    Scenario: Verify create order functionality with invalid data
      ...
      Then User creates new order
        | Product Name | Quantity | Customer Name | Street     | City    | State | Zip   | Card Nr | Expire Date |
        | ScreenSaver  | 2        | Techtorial    | 123 N tech | Chicago | IL    | zipCode | 1234567 | 12/21       |
#        | Product Name  | ScreenSaver |
#        | Quantity      | 2           |
#        | Customer Name | Techtorial  |
#        | Street        | str         |
#        | City          | Chicago     |
#        | ZipCode       | 60000       |
